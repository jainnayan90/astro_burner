...
- **Always** use daisyUI components for all UI elements — never manually write raw Tailwind utility classes for things daisyUI already provides (buttons, badges, cards, modals, alerts, etc.)
